...
tic % Αρχή χρονομέτρησης
            ...
            for ii=1:10 
                ...
                for i=1:ppc
                    L=[L,[1:3]]; % συνένωση απο δεξία (3 κατηγορίες)
                end

                % Προετοιμασία πινάκων για τα αποτελέσματα σε κάθε
                % cross-validation loop και ανά εποχή, πίνακες με την ακρίβεια ταξινόμησης γα κάθε σετ
                % χρήσιμες πληροφορίες για τα ποσοστά ταξινόμησης
